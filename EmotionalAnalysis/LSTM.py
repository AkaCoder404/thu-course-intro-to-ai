...
class Sentiment:
    ...
    def train(self,X_train, y_train,X_test, y_test,n_epoch=5 ):
        history = self.model.fit(X_train, y_train, batch_size=32, epochs=n_epoch, validation_data=(X_test, y_test), callbacks=[metrics])
...
def main():
    ...
    # train data +  validation, eturn results
